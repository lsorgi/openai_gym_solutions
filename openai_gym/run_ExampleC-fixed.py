...
class ExampleC(object):
    def __init__(self,
        ...
        self.model1 = models.Model(inputs=[input_nd], outputs=[output_nd])  # Changed args: input->inputs, output->outputs
        self.model1.summary()
        ...
        self.model2 = models.Model(inputs=[input_nd, output_nd_], outputs=[output_1d])  # Changed args: input->inputs, output->outputs
