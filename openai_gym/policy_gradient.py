"""
Simple policy gradient in Keras, discrete action space
...
class Agent(object):
    ...
    def __init__(self, input_dim, output_dim, hidden_dims):
        ...
        Gym Playing Agent
        Args:
            input_dim (int): the dimension of state. Same as `env.observation_space.shape[0]`
            output_dim (int): the number of discrete actions. Same as `env.action_space.n`
